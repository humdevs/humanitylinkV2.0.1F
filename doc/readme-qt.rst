Humanitylink-qt: Qt5 GUI for Humanitylink
===============================
...
Alternatively, install Qt Creator and open the `humanitylink-qt.pro` file.
...
The static binary version of Humanitylink is linked against libdb 5.0 (see also `this Debian issue`_).
...
installed causes humanitylink-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
